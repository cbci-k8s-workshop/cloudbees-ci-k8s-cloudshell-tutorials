...
gcloud container clusters create "kmadel" \
    --region "us-east1" \
...
The Operations Center for your CloudBees CI cluster should be running or starting up, and available at: [http://kmadel.workshop.cb-sa.io]/cjoc](http://kmadel.workshop.cb-sa.io]/cjoc])
